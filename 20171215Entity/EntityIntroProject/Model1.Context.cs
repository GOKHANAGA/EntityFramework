...
namespace EntityIntroProject
{
    ...
    public partial class NORTHWNDEntities : DbContext
    {
        ...
        public virtual int sp_GetProduct(Nullable<int> orderID, ObjectParameter productName)
        {
            var orderIDParameter = orderID.HasValue ?
                new ObjectParameter("orderID", orderID) :
                new ObjectParameter("orderID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_GetProduct", orderIDParameter, productName);
        }
        ...
        public virtual ObjectResult<sp_KategoriListele_Result> sp_KategoriListele(Nullable<int> employeeID)
        {
            var employeeIDParameter = employeeID.HasValue ?
                new ObjectParameter("employeeID", employeeID) :
                new ObjectParameter("employeeID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_KategoriListele_Result>("sp_KategoriListele", employeeIDParameter);
        }
